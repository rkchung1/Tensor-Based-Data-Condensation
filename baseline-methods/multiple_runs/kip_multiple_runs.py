...
from kip_tdbench import kip

def main():
    parser = argparse.ArgumentParser(
        description="Condense via Kernel Inducing Points (KIP) and evaluate with the same MLP."
    )
    ...
    parser.add_argument('--kip_epochs',
                        type=int, default=1000,
                        help="Number of optimization epochs for KIP.")
    parser.add_argument('--mlp_dim',
                        type=int, default=1024,
                        help="Hidden dimension for the kernel network in KIP.")
    ...
    parser.add_argument('--random_state',
                        type=int, default=0,
                        help="Random seed for KIP and MLP.")
